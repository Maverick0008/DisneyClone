...
const Detail = () => {
    return (
        <Container>
            ...
            <ImageTitle>
                <img src='https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/4A67A42FB16607DAE7E22266D3F00181965178ED1884047C2D982EE7D89D3554/scale?width=1440&aspectRatio=1.78' alt="ImageTitle" />
            </ImageTitle>
            <ControlContainer>
                <PlayButton>
